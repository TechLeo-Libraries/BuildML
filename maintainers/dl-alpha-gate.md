...
> **`2.4.0a1`** (post-depth / process). Do not treat TC4 / sign-off version pins
...
| TC4 | Version was `2.1.0a1` in `pyproject.toml` and `buildml/_version.py` at the DL alpha cut (HEAD is now `2.4.0a1`) | Historical packaging pin |
...
- [ ] Version was `2.1.0a1` at DL alpha cut (current HEAD package is `2.4.0a1`)
