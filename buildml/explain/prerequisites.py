...
_PROBES: tuple[PrerequisiteProbe, ...] = (
    ...
    _plan(
        ...
        "_dl_train_result",
        "Run session.dl.fit or session.dl.load_bundle first.",
    ),
    _plan(
        "cluster-plan",
        ...
        "_cluster_plan",
        "Run session.unsupervised.fit or session.unsupervised.load_bundle first.",
    ),
    _plan(
        "ensemble-plan",
        ...
        "_ensemble_plan",
        "Run session.ensemble.fit_voting, session.ensemble.fit_stacking, session.ensemble.fit_blending, or session.ensemble.load_bundle first.",
    ),
    _plan(
        "automl-plan",
        ...
        "_automl_plan",
        "Run session.automl.run or session.automl.load_bundle first.",
    ),
    _plan(
        "forecast-plan",
        ...
        "_forecast_plan",
        "Run session.forecast.fit or session.forecast.load_bundle first.",
    ),
    _plan(
        "anomaly-plan",
        ...
        "_anomaly_plan",
        "Run session.anomaly.fit or session.anomaly.load_bundle first.",
    ),
    _plan(
        "semisupervised-plan",
        ...
        "Run session.semisupervised.fit or session.semisupervised.load_bundle first.",
    ),
    _plan(
        "ssl-plan",
        ...
        "_ssl_plan",
        "Run session.ssl.fit_pretext or session.ssl.load_bundle first.",
    ),
    _plan(
        "ssl-head",
        ...
        "SSLHeadPlan",
        "_ssl_head_plan",
        "Run session.ssl.finetune_head first.",
    ),
    _plan(
        "activelearning-plan",
        ...
        "Run session.active_learning.fit or session.active_learning.load_bundle first.",
    ),
    _plan(
        "online-plan",
        ...
        "_online_plan",
        "Run session.online.fit or session.online.load_bundle first.",
    ),
    _plan(
        "multitask-plan",
        ...
        "_multitask_plan",
        "Run session.multitask.fit or session.multitask.load_bundle first.",
    ),
    _plan(
        "metalearning-plan",
        ...
        "_metalearning_plan",
        "Run session.metalearning.fit or session.metalearning.load_bundle first.",
    ),
    _plan(
        "federated-plan",
        ...
        "_federated_plan",
        "Run session.federated.fit or session.federated.load_bundle first.",
    ),
    _plan(
        "probabilistic-plan",
        ...
        "_probabilistic_plan",
        "Run session.probabilistic.fit or session.probabilistic.load_bundle first.",
    ),
    PrerequisiteProbe(
        ...
        remedy="Run session.causal.declare_assumptions, or pass assumptions= into session.causal.fit. Exploratory analysis is not a substitute.",
    ),
    _plan(
        "causal-plan",
        ...
        "_causal_plan",
        "Run session.causal.fit or session.causal.load_bundle first.",
    ),
    PrerequisiteProbe(
        key="graph-spec",
        ...
        remedy="Run session.graph.set_spec(edges, node_id_col=...) first.",
    ),
    _plan(
        "graph-plan",
        ...
        "_graph_plan",
        "Run session.graph.fit or session.graph.load_bundle first.",
    ),
    _plan(
        "symbolic-plan",
        ...
        "_symbolic_plan",
        "Run session.symbolic.fit or session.symbolic.load_bundle first.",
    ),
    _plan(
        "neuro-symbolic-plan",
        ...
        "Run session.symbolic.fit_neuro or session.symbolic.load_bundle first.",
    ),
    _plan(
        "cbr-plan",
        ...
        "_cbr_plan",
        "Run session.cbr.fit or session.cbr.load_bundle first.",
    ),
    _plan(
        "imitation-plan",
        ...
        "_imitation_plan",
        "Run session.rl.fit_imitation or session.rl.load_imitation_bundle first.",
    ),
    _plan(
        "rl-plan",
        ...
        "_rl_plan",
        "Run session.rl.fit or session.rl.load_bundle first.",
    ),
    _plan(
        "kg-plan",
        ...
        "_kg_plan",
        "Run session.kg.fit or session.kg.load_bundle first.",
    ),
    _plan(
        "tda-plan",
        ...
        "_tda_plan",
        "Run session.tda.fit or session.tda.load_bundle first.",
    ),
    _plan(
        "ranker-plan",
        ...
        "_ranker_plan",
        "Run session.ranking.fit or session.ranking.load_bundle first.",
    ),
    _plan(
        "recommender-plan",
        ...
        "_recommender_plan",
        "Run session.recommender.fit or session.recommender.load_bundle first.",
    ),
    _plan(
        "decision-plan",
        ...
        "_decision_plan",
        "Run session.decision.fit or session.decision.load_bundle first.",
    ),
    _plan(
        "synthesizer-plan",
        ...
        "_synthesizer_plan",
        "Run session.synthetic.fit or session.synthetic.load_bundle first.",
    ),
    PrerequisiteProbe(
        key="nlp-text-column",
    ...
    _plan(
        ...
        "fitted NlpTextPlan",
        "_nlp_text_plan",
        "Run session.nlp.fit_classifier or session.nlp.load_bundle first.",
    ),
    _plan(
        "nlp-topic-plan",
        ...
        "fitted topic plan",
        "_nlp_topic_plan",
        "Run session.nlp.fit_topics or session.nlp.load_bundle first.",
    ),
    _plan(
        "rag-corpus",
        ...
        "RAG corpus",
        "_rag_corpus",
        "Run session.rag.ingest_corpus first.",
    ),
    PrerequisiteProbe(
        key="rag-index",
        ...
        remedy="Run session.rag.embed_and_index, session.rag.upsert, or session.rag.load_bundle first.",
    ),
    _plan(
        "ai-provider",
        ...
        "_ai_provider",
        "Run session.ai.configure first.",
    ),
    PrerequisiteProbe(
        key="torch-extra",
