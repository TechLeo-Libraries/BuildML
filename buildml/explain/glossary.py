...
_ENTRIES: tuple[GlossaryTerm, ...] = (
    ...
    _term("conformal prediction", "A method for prediction intervals or sets with marginal coverage guarantees under suitable exchangeability assumptions; coverage is not guaranteed for each row or subgroup.", "conformal"),
    ...
    _term("extractive", "Selecting passages from the input rather than generating new sentences; selection and missing context can still mislead.", "extractive summarization"),
