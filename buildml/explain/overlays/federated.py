...
_OPERATIONS: tuple[OperationSpec, ...] = (
    ...
    _operation(
        ...
        "Export per-round client/server metrics after fit_federated for audit or plotting.",
        ...
        ordering=("After fit_federated (and optionally evaluate_federated).",),
        alternatives=("Reading Session.federated_fit_result.to_dict() in-process.",),
        ...
        state_changes=("History records export_round_history.",),
        result_reading=("Open the JSON and confirm round count matches n_rounds.",),
        next_steps=("save_federated_bundle when the global model must travel too.",),
        concepts=("federated-simulation",),
    ),
    _operation(
