...
_OPERATIONS: tuple[OperationSpec, ...] = (
    _operation(
        ...
        ordering=("After time_split; before fit_forecast for honest EDA.",),
        alternatives=("ts_decompose or ts_diagnostics for focused outputs.",),
    ...
    _operation(
        ...
        ("Wraps analyze_timeseries with decomposition enabled only.",),
        parameters=(
        ...
        alternatives=("analyze_timeseries for full report.",),
    ...
    _operation(
        ...
        ("Wraps analyze_timeseries with diagnostics enabled only.",),
        parameters=(
