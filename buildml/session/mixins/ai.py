...
class AiSessionMixin:
    ...
    Preferred namespaced API: ``session.ai.*`` (domain flat actions emit DeprecationWarning until BuildML 3.0).
    """
    ...
    def ai_configure(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.ai_ops.ai_configure`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def ai_egress_preview(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.ai_ops.ai_egress_preview`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def ai_dry_run(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.ai_ops.ai_dry_run`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def ai_advisor(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.ai_ops.ai_advisor`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def ai_plan(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.ai_ops.ai_plan`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def ai_execute(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.ai_ops.ai_execute`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def ai_run_plan(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.ai_ops.ai_run_plan`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def ai_run_autonomous(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.ai_ops.ai_run_autonomous`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def ai_status(self) -> dict[str, Any]:
        ...
        Session facade over :func:`buildml.session.ai_ops.ai_status`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def save_ai_transcript(self, path: str | Path, *, redact: bool = True) -> Path:
        ...
        Session facade over :func:`buildml.session.ai_ops.save_ai_transcript`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def load_ai_transcript(self, path: str | Path) -> Session:
        ...
        Session facade over :func:`buildml.session.ai_ops.load_ai_transcript`. See that function for parameter descriptions, exceptions, usage notes, and examples.
