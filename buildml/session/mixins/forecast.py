...
class ForecastSessionMixin:
    ...
    def fit_forecast(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.forecast_ops.fit_forecast`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def generate_forecast(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.forecast_ops.generate_forecast_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def evaluate_forecast(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.forecast_ops.evaluate_forecast_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def save_forecast_bundle(self, path: str | Path) -> Path:
        ...
        Session facade over :func:`buildml.session.forecast_ops.save_forecast_bundle_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def load_forecast_bundle(self, path: str | Path, *, trusted: bool = False) -> Session:
        ...
        Session facade over :func:`buildml.session.forecast_ops.load_forecast_bundle_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
