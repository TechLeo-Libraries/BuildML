...
class SemisupervisedSessionMixin:
    ...
    Preferred namespaced API: ``session.semisupervised.*`` (domain flat actions emit DeprecationWarning until BuildML 3.0).
    """
    ...
    def fit_semisupervised(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.semisupervised_ops.fit_semisupervised_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def predict_semisupervised(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.semisupervised_ops.predict_semisupervised_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def evaluate_semisupervised(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.semisupervised_ops.evaluate_semisupervised_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def save_semisupervised_bundle(self, path: str | Path) -> Path:
        ...
        Session facade over :func:`buildml.session.semisupervised_ops.save_semisupervised_bundle_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def load_semisupervised_bundle(self, path: str | Path, *, trusted: bool = False) -> Session:
        ...
        Session facade over :func:`buildml.session.semisupervised_ops.load_semisupervised_bundle_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
