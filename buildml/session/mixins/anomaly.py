...
class AnomalySessionMixin:
    ...
    def fit_anomaly(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.anomaly_ops.fit_anomaly`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def tune_anomaly_threshold(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.anomaly_ops.tune_anomaly_threshold_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def anomaly_capability_matrix() -> dict[str, Any]:
        ...
        Session facade over :func:`buildml.session.anomaly_ops.anomaly_capability_matrix_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def score_anomalies(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.anomaly_ops.score_anomalies_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def evaluate_anomaly(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.anomaly_ops.evaluate_anomaly_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def save_anomaly_bundle(self, path: str | Path) -> Path:
        ...
        Session facade over :func:`buildml.session.anomaly_ops.save_anomaly_bundle_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def load_anomaly_bundle(self, path: str | Path, *, trusted: bool = False) -> Session:
        ...
        Session facade over :func:`buildml.session.anomaly_ops.load_anomaly_bundle_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
