...
class SyntheticSessionMixin:
    ...
    Preferred namespaced API: ``session.synthetic.*`` (domain flat actions emit DeprecationWarning until BuildML 3.0).
    """
    ...
    def fit_synthesizer(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.synthetic_ops.fit_synthesizer_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def sample_synthetic(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.synthetic_ops.sample_synthetic_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def evaluate_synthetic(
        ...
        *,
        ...
        Session facade over :func:`buildml.session.synthetic_ops.evaluate_synthetic_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def synthetic_capability_matrix() -> dict[str, Any]:
        ...
        Session facade over :func:`buildml.session.synthetic_ops.synthetic_capability_matrix_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def save_synthetic_bundle(self, path: str | Path) -> Path:
        ...
        Session facade over :func:`buildml.session.synthetic_ops.save_synthetic_bundle_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
    ...
    def load_synthetic_bundle(self, path: str | Path, *, trusted: bool = False) -> Session:
        ...
        Session facade over :func:`buildml.session.synthetic_ops.load_synthetic_bundle_op`. See that function for parameter descriptions, exceptions, usage notes, and examples.
