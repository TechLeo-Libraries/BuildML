"""Tier C: sklearn KMeans + PCA twin for wine-cluster-segments."""
...
def main() -> None:
    ...
    pca = PCA(n_components=n_components, random_state=ctx.seed)
    z_train = pca.fit_transform(x_train)
    z_test = pca.transform(x_test)

    km = KMeans(n_clusters=n_clusters, random_state=ctx.seed, n_init=10)
    km.fit(z_train)
    ...
    write_comparison(
        ...
        industry={
            ...
            "leakage_controls": [
                ...
                "Cultivar labels used only for evaluation",
    ...
    print("wine-cluster-segments Tier C OK", industry_metrics)
