"""Tier C: sklearn IsolationForest twin for iot-sensor-anomaly."""
...
def main() -> None:
    ...
    frame, _ = load_iot_sensor_anomaly_synthetic(seed=ctx.seed)
    session = (
    ...
    print("iot-sensor-anomaly Tier C OK", industry_metrics)
