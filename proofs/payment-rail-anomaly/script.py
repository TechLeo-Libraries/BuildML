"""Tier A proof: payment-rail anomaly detection."""
...
def main() -> None:
    ...
    write_results(
        ctx,
        {
            ...
            "limitations": [
                "Synthetic payment authorizations",
                "Labeled metrics assume attack label quality",
            ],
        },
    )
    print("payment-rail-anomaly OK", labeled)
