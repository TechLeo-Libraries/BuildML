...
def select_features(x, y, strategy: str, estimator: str, number_of_features: int):
...
def build_regressor_model(regressor, x_train, y_train, x_test, y_test, kfold: int = None, cross_validation: bool = False):
...
def classifier_model_testing(classifier_model, variables_values: list, scaling: bool = False):
...
def regressor_model_testing(regressor_model, variables_values: list, scaling: bool = False):
    scaler = sp.StandardScaler()
    if scaling == False:
...
def build_classifier_model(classifier, x_train, y_train, x_test, y_test, kfold: int = None, cross_validation: bool = False):
...
def build_multiple_regressors(regressors: list or tuple, x_train, y_train, x_test, y_test, kfold: int = None, cross_validation: bool = False):
...
def build_multiple_classifiers(classifiers: list or tuple, x_train, y_train, x_test, y_test, kfold: int = None, cross_validation: bool = False):
...
def build_single_regressor_from_features(x, y, regressor, test_size: float, random_state: int, strategy: str, estimator: str, max_num_features: int = None, min_num_features: int = None, kfold: int = None, cv: bool = False):
...
def build_single_classifier_from_features(x, y, classifier, test_size: float, random_state: int, strategy: str, estimator: str, max_num_features: int = None, min_num_features: int = None, kfold: int = None, cv: bool = False):
    types1 = ["selectkbest", "selectpercentile"]
    types2 = ["rfe", "selectfrommodel"]
...
def build_multiple_regressors_from_features(x, y, regressors: list or tuple, test_size: float, random_state: int,  strategy: str, estimator: str, max_num_features: int = None, min_num_features: int = None, kfold: int = None, cv: bool = False):
    types1 = ["selectkbest", "selectpercentile"]
    types2 = ["rfe", "selectfrommodel"]
...
def build_multiple_classifiers_from_features(x, y, classifiers: list or tuple, test_size: float, random_state: int, strategy: str, estimator: str, max_num_features: int = None, min_num_features: int = None, kfold: int = None, cv: bool = False):
    types1 = ["selectkbest", "selectpercentile"]
    types2 = ["rfe", "selectfrommodel"]
...
def classifier_graph(classifier, x_train, y_train, cmap_train = "viridis", cmap_test = "viridis", size_train_marker: float = 10, size_test_marker: float = 10, x_test=None, y_test=None, resolution=100, plot_title="Decision Boundary"):
...
def FindK_KNN_Classifier(x_train, y_train, weight = "uniform", algorithm = "auto", metric = "minkowski", max_k_range: int = 31):
